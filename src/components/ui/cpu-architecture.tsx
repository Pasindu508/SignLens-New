    ...
    >
      ...
      >
        <path strokeDasharray="100 100" pathLength="100" d="M 10 20 h 79.5 q 5 0 5 5 v 30">
          {animateLines && (
            <animate attributeName="stroke-dashoffset" from="0" to="-200" dur="6s" begin="0s" repeatCount="indefinite" calcMode="spline" keySplines="0.25,0.1,0.5,1" keyTimes="0; 1" />
          )}
        </path>
        <path strokeDasharray="100 100" pathLength="100" d="M 180 10 h -69.7 q -5 0 -5 5 v 30">
          {animateLines && (
            <animate attributeName="stroke-dashoffset" from="0" to="-200" dur="6s" begin="0.8s" repeatCount="indefinite" calcMode="spline" keySplines="0.25,0.1,0.5,1" keyTimes="0; 1" />
          )}
        </path>
        <path d="M 130 20 v 21.8 q 0 5 -5 5 h -10">
          {animateLines && (
            <animate attributeName="stroke-dashoffset" from="0" to="-200" dur="6s" begin="1.6s" repeatCount="indefinite" calcMode="spline" keySplines="0.25,0.1,0.5,1" keyTimes="0; 1" />
          )}
        </path>
        <path d="M 170 80 v -21.8 q 0 -5 -5 -5 h -50">
          {animateLines && (
            <animate attributeName="stroke-dashoffset" from="0" to="-200" dur="6s" begin="2.4s" repeatCount="indefinite" calcMode="spline" keySplines="0.25,0.1,0.5,1" keyTimes="0; 1" />
          )}
        </path>
        <path strokeDasharray="100 100" pathLength="100" d="M 135 65 h 15 q 5 0 5 5 v 10 q 0 5 -5 5 h -39.8 q -5 0 -5 -5 v -20">
          {animateLines && (
            <animate attributeName="stroke-dashoffset" from="0" to="-200" dur="6s" begin="3.2s" repeatCount="indefinite" calcMode="spline" keySplines="0.25,0.1,0.5,1" keyTimes="0; 1" />
          )}
        </path>
        <path d="M 94.8 95 v -36">
          {animateLines && (
            <animate attributeName="stroke-dashoffset" from="0" to="-200" dur="6s" begin="4s" repeatCount="indefinite" calcMode="spline" keySplines="0.25,0.1,0.5,1" keyTimes="0; 1" />
          )}
        </path>
        <path d="M 88 88 v -15 q 0 -5 -5 -5 h -10 q -5 0 -5 -5 v -5 q 0 -5 5 -5 h 14">
          {animateLines && (
            <animate attributeName="stroke-dashoffset" from="0" to="-200" dur="6s" begin="4.8s" repeatCount="indefinite" calcMode="spline" keySplines="0.25,0.1,0.5,1" keyTimes="0; 1" />
          )}
        </path>
        <path d="M 30 30 h 25 q 5 0 5 5 v 6.5 q 0 5 5 5 h 20">
          {animateLines && (
            <animate attributeName="stroke-dashoffset" from="0" to="-200" dur="6s" begin="5.6s" repeatCount="indefinite" calcMode="spline" keySplines="0.25,0.1,0.5,1" keyTimes="0; 1" />
          )}
        </path>
      </g>
      ...
      <g>
        ...
        <text x="100" y="50" textAnchor="middle" dominantBaseline="middle" fontSize="7" fill={animateText ? "url(#cpu-text-gradient)" : "white"} fontWeight="600" letterSpacing="0.05em">
          {text}
        </text>
      </g>
